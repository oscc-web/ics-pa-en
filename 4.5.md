...
operations. This idea is very similar to the VFS we introduced in PA3, see [这里][SDL RWops]. In
...
> If this translation is not consistent, the device will access the wrong phyical memort location
...
As a emasculated OS, Nanos-lite can support quite a few complcated Navy apps such as "仙剑奇侠传".
...
what other questions need to be sovled to be an actual operating system?
