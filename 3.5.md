...
* `SDL_FillRect()`: Fill the specified rectangular area of the canvas with a specified color
...
To implement `SDL_LoadWAV()`, you need to understand the [WAV file format][wav file format].
